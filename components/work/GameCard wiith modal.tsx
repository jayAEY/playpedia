...
//               <DialogContent>
//                 <DialogHeader>
//                   <DialogTitle className="mx-8 text-3xl font-extrabold">
//                     {gameData?.name}
//                   </DialogTitle>
//                   <DialogDescription></DialogDescription>
//                 </DialogHeader>
//                 <div className="mx-2 md:mx-8 grid grid-cols-2 gap-4">
//                   <div>
...
//                       return (
//                         <p
//                           className="text-md text-foreground no-underline"
...
//                     </p>
//                     {gameData?.released && (
//                       <p className="text-md text-foreground no-underline">
//                         {gameData?.released}
//                       </p>
//                     )}
//                   </div>
...
//                   <table className="grid-start-1 mb-2 text-xs font-bold">
//                     <tbody>
//                       <tr className="hover:bg-primary">
//                         <td className="flex-1 border border-foreground p-2">
//                           Main
